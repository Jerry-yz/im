...
func (c *businessExtClient) UpdateUser(ctx context.Context, in *UpdateUserReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedBusinessExtServer) UpdateUser(context.Context, *UpdateUserReq) (*empty.Empty, error) {
