...
type ConnectIntClient interface {
	//  消息投递
	DeliverMessage(ctx context.Context, in *DeliverMessageReq, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *connectIntClient) DeliverMessage(ctx context.Context, in *DeliverMessageReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ConnectIntServer interface {
	//  消息投递
	DeliverMessage(context.Context, *DeliverMessageReq) (*empty.Empty, error)
...
func (UnimplementedConnectIntServer) DeliverMessage(context.Context, *DeliverMessageReq) (*empty.Empty, error) {
