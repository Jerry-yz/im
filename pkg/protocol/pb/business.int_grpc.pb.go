...
func (c *businessIntClient) Auth(ctx context.Context, in *AuthReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedBusinessIntServer) Auth(context.Context, *AuthReq) (*empty.Empty, error) {
