...
type LogicIntClient interface {
	...
	// 推送消息到房间
	PushRoom(ctx context.Context, in *pb.PushRoomReq, opts ...grpc.CallOption) (*empty.Empty, error)
	// 全服推送
...
func (c *logicIntClient) ConnSignIn(ctx context.Context, in *ConnSignInReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) MessageACK(ctx context.Context, in *MessageACKReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) Offline(ctx context.Context, in *OfflineReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) SubscribeRoom(ctx context.Context, in *SubscribeRoomReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) PushRoom(ctx context.Context, in *pb.PushRoomReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) PushAll(ctx context.Context, in *PushAllReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *logicIntClient) ServerStop(ctx context.Context, in *ServerStopReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type LogicIntServer interface {
	...
	// 推送消息到房间
	PushRoom(context.Context, *pb.PushRoomReq) (*empty.Empty, error)
	// 全服推送
...
func (UnimplementedLogicIntServer) ConnSignIn(context.Context, *ConnSignInReq) (*empty.Empty, error) {
...
func (UnimplementedLogicIntServer) MessageACK(context.Context, *MessageACKReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MessageACK not implemented")
}
func (UnimplementedLogicIntServer) Offline(context.Context, *OfflineReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Offline not implemented")
}
func (UnimplementedLogicIntServer) SubscribeRoom(context.Context, *SubscribeRoomReq) (*empty.Empty, error) {
...
func (UnimplementedLogicIntServer) PushRoom(context.Context, *pb.PushRoomReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushRoom not implemented")
}
func (UnimplementedLogicIntServer) PushAll(context.Context, *PushAllReq) (*empty.Empty, error) {
...
func (UnimplementedLogicIntServer) ServerStop(context.Context, *ServerStopReq) (*empty.Empty, error) {
...
func _LogicInt_PushRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicIntServer).PushRoom(ctx, req.(*pb.PushRoomReq))
	}
	return interceptor(ctx, in, info, handler)
}
