...
type LogicIntClient interface {
	...
	// 推送消息到房间
	PushRoom(ctx context.Context, in *pb.PushRoomReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 全服推送
...
func (c *logicIntClient) PushRoom(ctx context.Context, in *pb.PushRoomReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type LogicIntServer interface {
	...
	// 推送消息到房间
	PushRoom(context.Context, *pb.PushRoomReq) (*emptypb.Empty, error)
	// 全服推送
...
func (UnimplementedLogicIntServer) PushRoom(context.Context, *pb.PushRoomReq) (*emptypb.Empty, error) {
